...
NSB.Select_jqm = function(id, items, values, placeholder, selectedIndex, name, style, disabled, icon, iconPos, inline, nativeMenu, overlayTheme, Theme, mini, group, multiSelect, align, klass) {
  var i,s,arrItems,arrValues;
  arrItems=split(items, ",");
  if(items==''){arrItems=[]};
  arrValues=split(values, ",");
